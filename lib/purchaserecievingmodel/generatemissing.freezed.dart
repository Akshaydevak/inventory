...
mixin _$GenerateMissing {
  ...
  @JsonKey(ignore: true)
  $GenerateMissingCopyWith<GenerateMissing> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$_GenerateMissing implements _GenerateMissing {
  const _$_GenerateMissing(
      {this.id,
      this.remarks,
      this.note,
  ...
  @override
  String toString() {
    return 'GenerateMissing(id: $id, remarks: $remarks, note: $note, promisedRecieptDate: $promisedRecieptDate, plannedRecieptDate: $plannedRecieptDate, vendorTrnNumber: $vendorTrnNumber, vendorMailId: $vendorMailId, createdBy: $createdBy, vendorId: $vendorId, vendorAddress: $vendorAddress, inventoryId: $inventoryId, receivinglineId: $receivinglineId, orderLinses: $orderLinses)';
  }
...
mixin _$OrderLiness {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $OrderLinessCopyWith<OrderLiness> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$_OrderLines implements _OrderLines {
  const _$_OrderLines(
      ...
      @JsonKey(name: "receiving_line_id") this.receivinglineId});
  ...
  @override
  String toString() {
    return 'OrderLiness(orderLineId: $orderLineId, receivinglineId: $receivinglineId)';
  }
