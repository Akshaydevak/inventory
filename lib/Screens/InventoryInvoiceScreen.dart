    ...
    return Scaffold(
      ...
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) =>
                InventorysearchCubit()..getInventorySearch("code", tab: "II"),
          ),
          BlocProvider(
                  ...
                  state.maybeWhen(
                      ...
                      success: (data) {
                        setState(() {
                          ...
                          if (data.invoicedata!.invoiceLines?.isNotEmpty ==
                              true) {
                            print("entered 1st position");
                            setState(() {
                              purchaseCodeController.text =
                                  data.invoicedata?.orderCode ?? "";
                              inventoryId = data.invoicedata?.inventoryId ?? "";
                              invoiceCodeController.text =
                                  data.invoicedata?.invoicedCode ?? "";
                              invoiceStatusController.text =
                                  data.invoicedata?.invoiceStatus ?? "";

                              noteController.text =
                                  data.invoicedata?.notes ?? "";
                              remarksController.text =
                                  data.invoicedata?.remarks ?? "";
                              unitCostController.text =
                                  data.invoicedata?.unitCost.toString() ?? "";
                              focController.text =
                                  data.invoicedata?.foc.toString() ?? "";
                              discountController.text =
                                  data.invoicedata?.discount.toString() ?? "";
                              grandTotalController.text =
                                  data.invoicedata?.grandtotal.toString() ?? "";
                              variableAmountController.text =
                                  data.invoicedata?.vatableAmount.toString() ??
                                      "";
                              exciseTaxController.text =
                                  data.invoicedata?.excessTax.toString() ?? "";
                            ...
                            unitCostController.text =
                                data.calculationData?.unitCost.toString() ?? "";
                            discountController.text =
                                data.calculationData?.discount.toString() ?? "";
                            variableAmountController.text = data
                                    .calculationData?.vatableAmount
                                    .toString() ??
                                "";
                            variableAmountController.text = data
                                    .calculationData?.vatableAmount
                                ...
                                "";
                            grandTotalController.text =
                                data.calculationData?.grandtotal.toString() ??
                                    "";
                            focController.text =
                                data.calculationData?.foc.toString() ?? "";
                            vatController.text =
                                data.calculationData?.vat.toString() ?? "";
                            actualCostController.text =
                                data.calculationData?.actualCost.toString() ??
                                    "";
                            unitCostController.text =
                                data.calculationData?.unitCost.toString() ?? "";
                            exciseTaxController.text =
                                data.calculationData?.excessTax.toString() ??
                                    "";
                            data.lines != null
                      ...
                      success: (list) {
                        ...
                        setState(() {
                          if (result.isNotEmpty) {
                            ...
                            context
                                .read<InventoryReadCubit>()
                                .getInventoryRead(veritiaclid!);
                            print("Variable.verticalid" +
                                Variable.verticalid.toString());
                            setState(() {});
                          }
                        });
                      });
                  ...
                  state.maybeWhen(orElse: () {
                    ...
                    if (data.data1) {
                      ...
                      context
                          ...
                          .getInventorySearch("code", tab: "II");
                    } else {
                          ...
                          TextButtonLarge(
                            ...
                            onPress: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => InventoryPrintScreen(
                        ...
                        children: [
                          Expanded(
                            ...
                            children: [
                              ...
                              NewInputCard(
                                  readOnly: true,
                                  controller: orderedDateController,
                                  title: "ordered date"),
                              SizedBox(
                                height: height * .030,
                              ),
                        ...
                        children: [
                          ...
                          Button(Icons.check, Colors.grey, ctx: context,
                            ...
                            for (var i = 0;
                                i < additionalVariants.length;
                                i++) {
                              List result = additionalVariants
                                  .where((o) => o.isInvoiced == true)
                                  .toList();
                            }
                            print("additionalvariants" +
                                additionalVariants.toString());
                            InventoryPostModel model = InventoryPostModel(
                              purchaseOrderCode:
                                  purchaseCodeController.text ?? "",
                              ...
                              vatableAmount: double.tryParse(
                                  variableAmountController.text),
                              excessTax:
                                  double.tryParse(exciseTaxController.text),
                              actualCost:
              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                          ...
                          pw.Container(
                            ...
                            child: pw.Column(
                              ...
                              children: [
                                ...
                                pw.Text(
                                  "Shop no. 514 5th floor aditya arcademall",
                              ...
                              children: [
                                pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Container(
                                        padding: pw.EdgeInsets.only(top: 9),
                                        child: pw.Text("purchase order code :",
                                            style: pw.TextStyle(fontSize: 9))),
                                  ],
                                ),
                                pw.Column(
                          ...
                          if (table != null) ...[
                            for (var i = 0; i < table.length; i++)
                              pw.TableRow(children: [
                                pw.Container(
                                  padding:
                                      pw.EdgeInsets.only(top: height * .019),
                                  alignment: pw.Alignment.center,
                                ...
                                pw.Container(
                                  padding:
                                      pw.EdgeInsets.only(top: height * .014),
                                  alignment: pw.Alignment.center,
                                  height: 40,
                                  child: pw.Text(table[i].variantId ?? "",
                                      style: pw.TextStyle(
                                          fontSize: height * .013)),
                                ),
                                pw.Container(
                                ...
                                pw.Container(
                                  padding:
                                      pw.EdgeInsets.only(top: height * .019),
                                  alignment: pw.Alignment.center,
                                  child: pw.Text(table[i].purchaseUom ?? "",
                                      style: pw.TextStyle(
                                          fontSize: height * .013)),
                                ),
                                pw.Container(
                                ...
                                pw.Container(
                                  padding:
                                      pw.EdgeInsets.only(top: height * .019),
                                  alignment: pw.Alignment.center,
                                  child: pw.Text(table[i].vat.toString() ?? "",
                                      style: pw.TextStyle(
                                          fontSize: height * .013)),
                                  // fontSize: 12,
                                ),
                                pw.Container(
                                  padding:
                                      pw.EdgeInsets.only(top: height * .019),
                                  alignment: pw.Alignment.center,
                                  child: pw.Text(actualCost.toString() ?? "",
                                      style: pw.TextStyle(
                                          fontSize: height * .013)),
                                ),
                              ])
                    ...
                    pw.Container(
                        margin:
                            pw.EdgeInsets.symmetric(horizontal: width / 103),
                        width: width,
                        height: 27,
                        decoration: pw.BoxDecoration(
                          color: PdfColor.fromInt(0xAAF7F7F7),
                    ...
                    pw.Row(
                      children: [
                        pw.Container(
                          margin:
                              pw.EdgeInsets.symmetric(horizontal: width * .02),
                          child: pw.Column(
                            crossAxisAlignment: pw.CrossAxisAlignment.start,
                            children: [
                              pw.Text(
