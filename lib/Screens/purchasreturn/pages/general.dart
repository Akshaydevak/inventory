                          ...
                          child: Column(
                            children: [
                              ...
                              TopStableTable(
                                ...
                                grandToatl: grandTotalCostController, vat: vatController,liness:lines,assign: tableAssign,
                              ),
                              Container(
                                color: Colors.white,
                                height: 50,
...
class TopStableTable extends StatefulWidget {
  ...
  required this.returnOrederInvoicetStatus,required this.note,required this.remarks,required this.discount,required this.foc,required this.unitCost,
