...
class _PurchaseReturnGeneralState extends State<PurchaseReturnGeneral> {
  ...
  TextEditingController returnOrderInvoiceStatusController =
    ...
    if (lines.isNotEmpty) {
      for (var i = 0; i < lines.length; i++) {
        ...
        var b = await context
            ...
            .getCurrentStock(inventory.text, lines[i].variantId);
        print("b" + b.toString());
      }
      setState(() {});
    }
      ...
      child: Builder(builder: (context) {
        return MultiBlocListener(
          listeners: [
                  ...
                  if (data.data1) {
                    ...
                    Timer(Duration(seconds: 5), () {
                      setState(() {
                        ...
                        currentStock.clear();
                        context
                            .read<GeneralreadCubit>()
                            .getGeneralPurchaseReturnRead(veritiaclid!);
                      });
                    });
                  } else {
                ...
                state.maybeWhen(
                    ...
                    success: (data) {
                      setState(() {
                        ...
                        returnOrderStatusController.text =
                            data.returnOrderStatus ?? "";
                        orderCodeController.text = data.returnOrderCode ?? "";
                        returnOrderInvoiceStatusController.text =
                            data.returnInvoiceStatus ?? "";
            ...
            BlocListener<PurchasereturngeneralpatchCubit,
                PurchasereturngeneralpatchState>(
              listener: (context, state) {
                              ...
                              child: Column(
                                children: [
                                  ...
                                  TopStableTable(
                                      ...
                                      vendorCode: vendorCodeController,
                                      inventory: inventory,
                                      select: select,
                                      orderCode: orderCodeController,
                                      vendorAddress: vendorAddressController,
                                      vendorMailId: vendorMailId,
                                      vendorTRNnumber:
                                          vendorTrnNumberController,
                                      paymentCode: paymentCodeController,
                                      orderDate: orderDateController,
                                      paymentStatus: paymentStatusController,
                                      returnOrderStatus:
                                          returnOrderStatusController,
                                      returnOrederInvoicetStatus:
                                          returnOrderInvoiceStatusController,
                                      purchaseInvoiceId:
                                          purchaseInvoiceIdController,
                                      note: noteController,
                                                          ...
                                                          TableRow(
                                                              ...
                                                              children: [
                                                                    ...
                                                                    onChanged:
                                                                      ...
                                                                      if (va ==
                                                                        ...
                                                                        if (qty == 0 ||
                                                                          ...
                                                                          Vamount =
                                                                              (((unitcost! * qty!) + excess!) - dis!).toDouble();
                                                                          if (vat == 0 ||
                                                                              vat == "") {
                                                                            vactualCost =
                                                                                Vamount;
                                                                ...
                                                                TableCell(
                                                                  verticalAlignment:
                                                                      TableCellVerticalAlignment
                                                                          .middle,
                                                                  child: CheckedBoxs(
                                                                      valueChanger: lines![i].isInvoiced ==
                                                                              null
                                                                          ? false
                                                                          : lines![i]
                                                                              .isInvoiced,
                                                                ...
                                                                TableCell(
                                                                  ...
                                                                  child:
                                                                      CheckedBoxs(
                                                                          valueChanger: lines?[i].isActive == null
                                                                              ? false
                                                                              : lines?[i]
                                                                                  .isActive,
                                                                          onSelection:
                                    ...
                                    children: [
                                      ...
                                      Button(Icons.check, Colors.grey,
                                        ...
                                        if (updateCheck)
                                              ...
                                              if (select) {
                                                lines[i] = lines[i].copyWith(
                                                    purchaseInvoiceLineCode:
                                                        lines[i].invoiceLineCode ??
                                                            "");
                                                lines[i] = lines[i].copyWith(
                                                    returnOrderLineCode: lines[
                                                                i]
                                                            .invoiceLineCode ??
                                                        "");
                                                lines[i] = lines[i].copyWith(
                                                    purchaseInvoiceLineId: lines[
                                                                i]
                                                            .purchaseInvoiceLineCode ??
                                                        "");
                                                setState(() {});
                                            ...
                                            for (var i = 0;
                                              ...
                                              patchLists.add(PatchLiness(
                                                ...
                                                discount:
                                                    lines[i].discount ?? 0,
                                                vatableAmount:
                                                    lines[i].vatableAmount ?? 0,
                                                excessTax:
                                                    lines[i].excessTax ?? 0,
                                                vat: lines[i].vat ?? 0,
                                                actualCost:
                                                    lines[i].actualCost ?? 0,
                                                grandTotal:
                                                    lines[i].grandTotal ?? 0,
                                              ));
                                            }
                                            setState(() {});
                                          }
                                          ...
                                          ReturnGeneralPatchModel model1 =
                                              ReturnGeneralPatchModel(
...
class TopStableTable extends StatefulWidget {
  ...
  TopStableTable(
      ...
      // required this.assignTable,
      required this.vendorCode,
      required this.vendorAddress,
      required this.vendorTRNnumber,
      required this.paymentCode,
      required this.paymentStatus,
      required this.vendorMailId,
      required this.returnOrederInvoicetStatus,
      required this.note,
      ...
      required this.returnOrderStatus});
  @override
            ...
            state.maybeWhen(
                ...
                success: (data) {
                  setState(() {
                    ...
                    data.lines != null
                        ? widget.liness = data.lines ?? []
                        : widget.liness = [];
                    if (widget.liness != null) widget?.assign!(widget.liness);
            ...
            children: [
              Expanded(
                ...
                children: [
                  ...
                  widget.select
                      ? SelectableDropDownpopUp(
                          ...
                          onSelection: (PurchaseInvoice? va) {
                            ...
                            // setState(() {
                            widget.purchaseInvoiceId.text =
                                va?.invoiceCode ?? "";
                            print("widget.purchaseInvoiceId.text" +
                                widget.purchaseInvoiceId.text.toString());

                            setState(() {
                              context
                                  .read<PurchaseinvoiceReadCubit>()
                                  .getGeneralInvoiceRead(va?.id);
                              setState(() {});
                            });
                          },
                        )
                      : NewInputCard(
                          readOnly: true,
                          controller: widget.purchaseInvoiceId,
                  ...
                  NewInputCard(
                      readOnly: true,
                      controller: widget.vendorAddress,
              ...
              Expanded(
                ...
                children: [
                  ...
                  NewInputCard(
                      readOnly: true,
                      controller: widget.returnOrderStatus,
                  ...
                  NewInputCard(
                      readOnly: true,
                      controller: widget.returnOrederInvoicetStatus,
                      title: "Return Order Invoice Status"),
                  SizedBox(
                    height: height * .030,
                  ),
                  NewInputCard(
