...
@freezed
class ReturnGeneralPatchModel with _$ReturnGeneralPatchModel {
  const factory ReturnGeneralPatchModel({
    final int? id,
    final String? note,
    final String? remarks,
    final double? foc,
  ...
  }) = _ReturnGeneralPatchModel;
  factory ReturnGeneralPatchModel.fromJson(Map<String, dynamic> json) =>
      _$ReturnGeneralPatchModelFromJson(json);
}
@freezed
class PatchLiness with _$PatchLiness {
  const factory PatchLiness({
    // final int? id,
    final double? foc,
    final double? discount,
    final double? vat,
  ...
  factory PatchLiness.fromJson(Map<String, dynamic> json) =>
      _$PatchLinessFromJson(json);
}
