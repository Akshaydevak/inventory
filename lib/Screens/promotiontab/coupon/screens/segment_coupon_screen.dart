...
class SegmentCouponGrowableTable extends StatefulWidget {
  ...
  @override
  SegmentCouponGrowableTableState createState() =>
      SegmentCouponGrowableTableState();
}

class SegmentCouponGrowableTableState
    extends State<SegmentCouponGrowableTable> {
  List<Segment>table = [];
  String segmentName = "";
  String segmentCode = "";
  bool isActive = false;
