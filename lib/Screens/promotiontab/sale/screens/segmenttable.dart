...
class SegmentGrowableTable extends StatefulWidget {
  ...
  SegmentGrowableTable({required this.table, required this.updation, this.key});

  @override
  SegmentGrowableTableState createState() => SegmentGrowableTableState();
}

class SegmentGrowableTableState extends State<SegmentGrowableTable> {
  List<Segment>table = [];
  String segmentName = "";
  String segmentCode = "";
  bool isActive = false;
          ...
          BlocListener<PromtionSaleReadCubit, PromtionSaleReadState>(
            listener: (context, state) {
              ...
              state.maybeWhen(
                  ...
                  success: (data) {
                    print("Akshayyyyyyyyyyyyyyyyyyyyyyaaaaaaaaaaaa");
                    setState(() {
