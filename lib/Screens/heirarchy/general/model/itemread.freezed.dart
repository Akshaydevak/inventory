...
mixin _$ItemReadModel {
  ...
  @JsonKey(ignore: true)
  $ItemReadModelCopyWith<ItemReadModel> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$_ItemReadModel implements _ItemReadModel {
  const _$_ItemReadModel(
      {this.id,
      this.code,
      this.description,
      this.name,
...
class _$_Barcode implements _Barcode {
  ...
  @override
  String toString() {
    return 'Barcode(key: $key, fileName: $fileName, barcodeNumber: $barcodeNumber)';
  }
...
class _$_QrCode implements _QrCode {
  const _$_QrCode(
      ...
      this.content,
      @JsonKey(name: "file_name") this.fileName,
      @JsonKey(name: "qrcode_number") this.qrCodeNumber});

  factory _$_QrCode.fromJson(Map<String, dynamic> json) =>
      _$$_QrCodeFromJson(json);
  ...
  @override
  String toString() {
    return 'QrCode(key: $key, content: $content, fileName: $fileName, qrCodeNumber: $qrCodeNumber)';
  }
...
mixin _$ItemMeta {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $ItemMetaCopyWith<ItemMeta> get copyWith =>
      throw _privateConstructorUsedError;
}
...
/// @nodoc
@JsonSerializable()
class _$_ItemMeta implements _ItemMeta {
  const _$_ItemMeta({this.description});

  factory _$_ItemMeta.fromJson(Map<String, dynamic> json) =>
      _$$_ItemMetaFromJson(json);
  ...
  @override
  String toString() {
    return 'ItemMeta(description: $description)';
  }
