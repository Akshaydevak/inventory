...
mixin _$ItemCreationModel {
  ...
  @JsonKey(ignore: true)
  $ItemCreationModelCopyWith<ItemCreationModel> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$_ItemCreationModel implements _ItemCreationModel {
  const _$_ItemCreationModel(
      {this.name,
      this.barcode,
      this.description,
      this.image1,
  ...
  factory _$_ItemCreationModel.fromJson(Map<String, dynamic> json) =>
      _$$_ItemCreationModelFromJson(json);
