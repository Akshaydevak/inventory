...
mixin _$MaterialCreationtModel {
  ...
  @JsonKey(ignore: true)
  $MaterialCreationtModelCopyWith<MaterialCreationtModel> get copyWith =>
...
/// @nodoc
@JsonSerializable()
class _$_MaterialCreationtModel implements _MaterialCreationtModel {
  const _$_MaterialCreationtModel(
      {this.description,
      this.status,
      this.name,
      this.image,
  ...
  factory _$_MaterialCreationtModel.fromJson(Map<String, dynamic> json) =>
      _$$_MaterialCreationtModelFromJson(json);
  ...
  @override
  String toString() {
    return 'MaterialCreationtModel(description: $description, status: $status, name: $name, image: $image, searchNmae: $searchNmae, displayName: $displayName, categoryCode: $categoryCode, isActive: $isActive)';
  }
